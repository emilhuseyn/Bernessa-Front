      ...
      <PageTransition>
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          <div className="absolute inset-0">
            <div className="absolute left-[15%] top-[15%] h-56 w-56 rounded-full bg-primary-500/20 blur-[150px]" />
            <div className="absolute right-[10%] top-[40%] h-72 w-72 rounded-full bg-secondary-500/15 blur-[170px]" />
